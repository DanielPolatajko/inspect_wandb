...
class TestInspectWandBBaseSettings:
    ...
    def test_reads_settings_from_wandb_settings_file(
        self, initialise_wandb: None
    ) -> None:
        # Given
        cwd = Path.cwd()
    ...
    def test_environment_variables_set_to_bools(
    ...
    def test_hooks_disabled_when_project_and_entity_are_not_set_but_hooks_are_enabled(
    ...
    def test_no_validation_errors_when_hooks_are_disabled(
        self, monkeypatch: pytest.MonkeyPatch
    ) -> None:
        # Given
...
class TestPriorityOrdering:
    ...
    def test_init_settings_highest_priority(
    ...
    def test_environment_variables_second_priority(
        self, monkeypatch: pytest.MonkeyPatch, initialise_wandb: None
    ) -> None:
        # Given
        cwd = Path.cwd()
